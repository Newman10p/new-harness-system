...
export class AgentEventBus {
  ...
  private bridgeToHud(event: AgentEvent): void {
    ...
    switch (type) {
      ...
      case "message_end":
        // NOTE: jarvis_speech is NOT bridged here because AgentLoop already
        // emits jarvis_speech directly with properly parsed/cleaned text.
        // Emitting here too caused duplicate messages in the HUD.
        break;
