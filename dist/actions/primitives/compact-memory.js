...
exports.compactMemory = compactMemory;
const promises_1 = __importDefault(require("node:fs/promises"));
async function compactMemory(action, ctx) {
    ...
    try {
        ...
        await promises_1.default.writeFile(filePath, compacted.trim(), "utf-8");
        await ctx.audit({
...
//# sourceMappingURL=compact-memory.js.map